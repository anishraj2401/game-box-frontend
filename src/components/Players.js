...
export default function Players() {
    const [currentUser, setCurrentUser] = useContext(userLoginContextObj);
    ...
    return (
        <div>
            ...
            {/* <div className='d-flex justify-content-center align-items-center'>
                <nav className="navbar navbar-light  text-white d-flex justify-content-around">
                    <ul className="nav nav-pills ">
                        <li className="nav-item">
                            <NavLink className="nav-link" to="addProduct">Add Wallet</NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink className="nav-link" to="gamesList">Games</NavLink>
                        </li>
                    </ul>
                </nav>
            </div> */}
