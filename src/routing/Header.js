...
export default function Header() {
    ...
    const { wallet } = useContext(walletContextObj);
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
            <div className="container">
                ...
                <button className={`navbar-toggler close-icon ${!isNavOpen ? 'd-none' : ''}`}
                ...
                <div className={`collapse navbar-collapse ${isNavOpen ? '' : 'show'}`} id="navbarNav">
                    <ul className="navbar-nav ml-auto d-flex justify-content-around align-items-center">
                        ...
                        {loginStatus === false ? (
                            ...
                            <li className="nav-item">
                                <NavLink className="nav-link" to="/top-up">Wallet TopUp</NavLink>
                            </li>
                            <li class="nav-item">
                                <NavLink className="nav-link" to="/top-up" activeClassName="active">
                                    <button className='btn btn-primary' type="submit">Balance: {wallet}</button>
                                </NavLink>
                            </li>
